...
The shipping API requires both an API key and OAuth authentication. ParcelNET handles token acquisition and caching automatically using your `Username` and `Password` credentials.
