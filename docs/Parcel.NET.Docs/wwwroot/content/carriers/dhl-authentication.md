...
Parcel.NET handles all authentication automatically through delegating handlers.
...
Parcel.NET uses `DelegatingHandler` to inject authentication headers transparently:
